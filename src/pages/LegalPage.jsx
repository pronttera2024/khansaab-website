    ...
    >
      <div className="container" style={{ maxWidth: 880 }}>
        <div className="mono" style={{ opacity: 0.55, marginBottom: 32 }}>
          ...
          <span>
            {" "}
            / Legal / <span style={{ color: "var(--ink)" }}>{data.title}</span>
          </span>
        </div>
        ...
        >
          ...
          <p style={{ fontSize: 14, opacity: 0.75, marginBottom: 16 }}>
            Our guide team replies to every message within an hour.
          </p>
          <button
            className="btn btn-gold"
            onClick={() =>
              openWhatsApp(
                "Hi! I have a question about your " + data.title + ".",
              )
            }
          >
