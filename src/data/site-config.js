...
export const CONTACT = {
  ...
  email: {
    guide: "khansaabstoreoffical@gmail.com",
...
export const WHATSAPP_MESSAGES = {
  ...
  guide: "Hello KhanSaab — I'd like guide help.",
  ...
  fitting: (productName, size) =>
    `Hello KhanSaab — I'd like to book a fitting for the ${productName} (size ${size}).`,
};
