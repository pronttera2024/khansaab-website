...
export const LEGAL_PAGES = {
  'legal-terms': {
    ...
    sections: [
      ...
      { h: '3. Pricing & payment', b: 'Prices are listed in Indian Rupees (₹) unless otherwise stated and include VAT where applicable. We accept Visa, Mastercard, Amex, Apple Pay, Tabby and Tamara. Payment is captured at the time of order.' },
