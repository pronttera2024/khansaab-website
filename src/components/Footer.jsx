...
export default function Footer() {
  const { opencollection, openSizeGuide } = useModals();
      ...
      <div className="container" style={{ position: "relative" }}>
        ...
        >
          <div>
            ...
            >
              From our collection in Pune, we serve discerning gentlemen across
              India and beyond. Whether it's a bespoke thobe, bulk orders or a
          ...
          >
            ...
            <div>
              ...
              <div style={{ fontSize: 14, opacity: 0.8, lineHeight: 1.8 }}>
                <a
                  href={`mailto:${CONTACT.email.guide}`}
                  style={{ color: "inherit", textDecoration: "none" }}
                  onMouseEnter={(e) =>
                    (e.currentTarget.style.color = "var(--gold)")
                  }
        ...
        >
          <div>
            ...
            <p
              className="arabic"
              style={{ marginTop: 18, fontSize: 22, color: "var(--gold)" }}
            >
              {BRAND.taglineArabic}
            </p>
          </div>
          {Object.values(FOOTER_LINKS).map((group) => {
            const actions = { opencollection, openSizeGuide };
            return (
              <FooterLinks
                key={group.title}
                title={group.title}
