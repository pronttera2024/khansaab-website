      ...
      >
        ...
        <div style={{ overflowY: "auto", padding: "24px 32px 40px", flex: 1 }}>
          ...
          >
            ...
            <button
              onClick={() => openWhatsApp(WHATSAPP_MESSAGES.sizeHelp)}
              style={{
                color: "var(--emerald)",
              ...
              <tbody>
                {SIZE_ROWS.map((r, i) => (
                  <tr
                    key={r.size}
                    style={{
                      background: i % 2 ? "transparent" : "rgba(15,59,46,0.04)",
                    }}
                  >
          ...
          >
            {HOW_TO_MEASURE.map((m) => (
              ...
              >
                ...
                <span style={{ fontSize: 13, opacity: 0.78, lineHeight: 1.65 }}>
                  {m.d}
                </span>
              </li>
            ))}
          ...
          <div data-sheet-footer>
            <button
              onClick={() => openWhatsApp(WHATSAPP_MESSAGES.measureHelp)}
