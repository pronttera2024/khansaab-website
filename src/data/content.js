// ─── Content Blocks ──────────────────────────────────────────────────────────
// Miscellaneous section content: process steps, trust badges, CTA copy, etc.

export const BESPOKE_PROCESS_PANELS = [
  {
    d: 'Day 01',
    t: 'Pattern',
    body: 'A paper pattern is cut to your measurements.',
    src: '/assets/process_1.png',
    bg: 'var(--emerald)',
  },
  {
    d: 'Day 02–04',
  ...
  },
  {
    ...
    src: '/assets/process_4.png',
    bg: 'var(--charcoal)',
  },
]

export const BESPOKE_PROCESS_STEPS = [
...
export const ATELIER_DIALOG = {
  arabicTitle: 'خياطة على المقاس',
  eyebrow: 'The KhanSaab Atelier',
  heading: 'Make custom-size',
  headingAccent: 'cloth.',
...
export const STORY_RIBBONS = {
  ribbon1: { words: ['Heritage', 'Craftsmanship', 'Devotion', 'Khaleej', 'Atelier'], color: 'var(--gold)', bg: 'var(--ink)' },
  ribbon2: { words: ['Made by hand', 'Made to last', 'Made to be passed on'], direction: 'right', color: 'var(--ink)', bg: 'var(--gold)' },
}
