...
export const ALL_PRODUCTS = [
  {
    ...
    occasion: 'everyday',
    sizes: ['S', 'M', 'L', 'XL', 'XXL'],
    description: 'A timeless Saudi thobe in pure white premium cotton. Features a clean mandarin collar, straight-cut silhouette, and hidden placket for a refined, minimalist look. Perfect for daily wear and Friday prayers.',
    features: [
      { icon: '✦', title: 'Mandarin collar', desc: 'Clean-cut stand collar with concealed button closure.' },
      { icon: '✦', title: 'Premium cotton', desc: '100% long-staple cotton, breathable and soft against skin.' },
      { icon: '✦', title: 'Hidden placket', desc: 'Concealed front buttons for a seamless, polished finish.' },
  ...
  },
  {
    ...
    occasion: 'everyday',
    sizes: ['S', 'M', 'L', 'XL', 'XXL'],
    description: 'An elegant Emirati-style thobe in sophisticated grey taupe. Features a signature tarboosh collar, full-length sleeves with French cuffs, and a tailored drape that commands presence in any gathering.',
    features: [
      { icon: '✦', title: 'Tarboosh collar', desc: 'Signature Emirati collar with structured stand and elegant fold.' },
      { icon: '✦', title: 'French cuffs', desc: 'Double-fold cuffs with premium cufflink-ready buttonholes.' },
      { icon: '✦', title: 'Tailored drape', desc: 'Precision-cut through the shoulders for a commanding silhouette.' },
      { icon: '✦', title: 'Full-length sleeves', desc: 'Extended sleeves with clean finishing at the wrist.' },
    ],
    images: {
  ...
  },
  {
    ...
    occasion: 'wedding',
    sizes: ['S', 'M', 'L', 'XL', 'XXL'],
    description: 'A majestic ceremonial bisht in deep obsidian black, adorned with intricate hand embroidery along the edges. Reserved for weddings, Eid celebrations, and occasions of the highest honour.',
    features: [
      { icon: '✦', title: 'Hand embroidery', desc: 'Hand-stitched border crafted by our master artisans.' },
      { icon: '✦', title: 'Ceremonial weight', desc: 'Premium heavyweight fabric with a regal drape.' },
      { icon: '✦', title: 'Made to order', desc: 'Individually crafted to your measurements over 21 days.' },
      { icon: '✦', title: 'Obsidian black', desc: 'Deep, lustrous black that holds its richness wear after wear.' },
    ],
    images: {
  ...
  },
  {
    ...
    occasion: 'festive',
    sizes: ['S', 'M', 'L', 'XL', 'XXL'],
    description: 'A statement-making Moroccan-cut thobe in rich mustard gold. Crafted from a premium wool blend for texture and warmth, with ornate embroidery along the neckline and a relaxed, flowing silhouette.',
    features: [
      { icon: '✦', title: 'Moroccan embroidery', desc: 'Intricate hand-embroidered motifs along the neckline and chest.' },
      { icon: '✦', title: 'Wool blend fabric', desc: 'Premium wool-cotton blend for warmth with breathability.' },
      { icon: '✦', title: 'Relaxed silhouette', desc: 'Flowing Moroccan cut with generous ease through the body.' },
      { icon: '✦', title: 'Festive palette', desc: 'Rich mustard gold that radiates warmth and celebration.' },
    ],
    images: {
  ...
  },
  {
    ...
    occasion: 'everyday',
    sizes: ['S', 'M', 'L', 'XL', 'XXL'],
    description: 'A contemporary Saudi thobe in a distinctive onion pink hue. Made from breathable premium cotton with a classic collar, concealed buttons, and a modern slim fit for the fashion-forward gentleman.',
    features: [
      { icon: '✦', title: 'Modern colour', desc: 'Distinctive onion pink — subtle, warm, and contemporary.' },
      { icon: '✦', title: 'Slim fit', desc: 'Tapered modern cut through the body and sleeves.' },
      { icon: '✦', title: 'Breathable cotton', desc: 'Premium long-staple cotton for all-day comfort.' },
  ...
  },
  {
    ...
    occasion: 'business',
    sizes: ['S', 'M', 'L', 'XL', 'XXL'],
    description: 'Designed for the travelling professional, this dusty blue thobe is crafted from wrinkle-resistant Japanese cotton. Lightweight, breathable, and impeccably structured — it arrives at your destination as crisp as when you left.',
    features: [
      { icon: '✦', title: 'Japanese cotton', desc: 'Wrinkle-resistant fabric that stays crisp through travel.' },
      { icon: '✦', title: 'Travel-ready', desc: 'Lightweight construction that packs flat and shakes out fresh.' },
      { icon: '✦', title: 'Structured collar', desc: 'Stays sharp without ironing, even after hours of wear.' },
      { icon: '✦', title: 'Diplomatic blue', desc: 'A refined muted blue suited for professional settings.' },
    ],
    images: {
  ...
  },
  {
    ...
    occasion: 'festive',
    sizes: ['S', 'M', 'L', 'XL', 'XXL'],
    description: 'A refined Emirati thobe in understated stone grey, ideal for festive occasions. Features a structured collar, precision tailoring through the shoulders, and a subtle sheen that catches the light beautifully.',
    features: [
      { icon: '✦', title: 'Emirati tailoring', desc: 'Precision-cut shoulders with a structured, confident drape.' },
      { icon: '✦', title: 'Subtle sheen', desc: 'Premium fabric with a gentle lustre for festive occasions.' },
      { icon: '✦', title: 'Structured collar', desc: 'Holds its shape throughout long celebrations.' },
      { icon: '✦', title: 'Stone grey tone', desc: 'A versatile neutral that pairs with any accessory.' },
    ],
    images: {
  ...
  },
  {
    ...
    occasion: 'wedding',
    sizes: ['S', 'M', 'L', 'XL', 'XXL'],
    description: 'A distinguished ceremonial thobe in deep olive green. Tailored with military-inspired precision, featuring reinforced seams, a structured collar, and a drape suited for formal gatherings and wedding celebrations.',
    features: [
      { icon: '✦', title: 'Ceremonial grade', desc: 'Heavyweight fabric with a formal, distinguished drape.' },
      { icon: '✦', title: 'Reinforced seams', desc: 'Double-stitched at stress points for lasting durability.' },
      { icon: '✦', title: 'Deep olive tone', desc: 'A rich, earthy green that exudes confidence and calm.' },
      { icon: '✦', title: 'Wedding-ready', desc: 'Designed for grooms and guests at life’s grandest moments.' },
    ],
    images: {
  ...
  },
  {
    ...
    occasion: 'festive',
    sizes: ['S', 'M', 'L', 'XL', 'XXL'],
    description: 'A luxurious Moroccan-cut thobe in warm golden beige with sage undertones. Features intricate neckline embroidery, a relaxed silhouette, and premium fabric that drapes gracefully for festive occasions.',
    features: [
      { icon: '✦', title: 'Sage undertones', desc: 'Golden beige with a subtle green warmth in natural light.' },
      { icon: '✦', title: 'Neckline embroidery', desc: 'Hand-finished Moroccan motifs along the collar and chest.' },
      { icon: '✦', title: 'Premium drape', desc: 'Fabric weight chosen for an effortless, flowing fall.' },
  ...
  },
  {
    ...
    occasion: 'everyday',
    sizes: ['S', 'M', 'L', 'XL', 'XXL'],
    description: 'A versatile Saudi thobe in earthy khaki, perfect for everyday sophistication. Made from durable premium cotton with a classic mandarin collar, reinforced stitching, and a comfortable relaxed fit.',
    features: [
      { icon: '✦', title: 'Durable cotton', desc: 'Heavy-duty premium cotton built for daily wear.' },
      { icon: '✦', title: 'Earthy khaki', desc: 'A warm, grounding neutral that works with everything.' },
      { icon: '✦', title: 'Reinforced stitching', desc: 'Double-needle construction at seams for long-lasting wear.' },
      { icon: '✦', title: 'Relaxed fit', desc: 'Comfortable ease through the body for all-day movement.' },
    ],
    images: {
  ...
  },
  {
    ...
    occasion: 'festive',
    sizes: ['S', 'M', 'L', 'XL', 'XXL'],
    description: 'A distinguished Kuwaiti-style thobe in muted dusty grey, designed for Eid celebrations. Features a characteristic front pleat, button cuffs, and a lightweight fabric that keeps you comfortable through long festivities.',
    features: [
      { icon: '✦', title: 'Kuwaiti front pleat', desc: 'Signature centre pleat for a sharp, structured front.' },
      { icon: '✦', title: 'Button cuffs', desc: 'Adjustable cuffs with mother-of-pearl buttons.' },
      { icon: '✦', title: 'Eid-ready', desc: 'Lightweight fabric perfect for celebrating through the day.' },
      { icon: '✦', title: 'Dusty grey', desc: 'A soft, muted tone that photographs beautifully.' },
    ],
    images: {
      primary: 'https://res.cloudinary.com/dljg7vpso/image/upload/v1779383586/29_ol0rem.png',
      secondary: 'https://res.cloudinary.com/dljg7vpso/image/upload/v1779387526/KhanSaab_1_vpmasz.png',
    },
  },
  {
    id: 'dark-grey-thobe',
    ...
    occasion: 'wedding',
    sizes: ['S', 'M', 'L', 'XL', 'XXL'],
    description: 'A luxurious ceremonial thobe in rich dark grey, woven from premium camel wool for exceptional warmth and softness. The fabric’s natural drape and subtle texture make it ideal for weddings and formal winter events.',
    features: [
      { icon: '✦', title: 'Camel wool', desc: 'Rare, ultra-soft fibre prized for warmth without bulk.' },
      { icon: '✦', title: 'Natural texture', desc: 'Subtle weave variation that adds depth and character.' },
      { icon: '✦', title: 'Winter weight', desc: 'Insulating warmth for cooler evenings and seasons.' },
      { icon: '✦', title: 'Formal drape', desc: 'Falls with a gravity that suits life’s grandest occasions.' },
    ],
    images: {
  ...
  },
  {
    ...
    occasion: 'everyday',
    sizes: ['S', 'M', 'L', 'XL', 'XXL'],
    description: 'A bold Saudi thobe in regal violet, crafted from soft premium cotton. Features a modern collar design, tapered silhouette, and meticulous finishing for the gentleman who dares to stand apart.',
    features: [
      { icon: '✦', title: 'Regal violet', desc: 'A rich, confident hue inspired by royal heritage.' },
      { icon: '✦', title: 'Modern collar', desc: 'Updated design that bridges tradition and contemporary style.' },
      { icon: '✦', title: 'Tapered cut', desc: 'Slim through the body for a sharp, modern silhouette.' },
  ...
  },
  {
    ...
    occasion: 'everyday',
    sizes: ['S', 'M', 'L', 'XL', 'XXL'],
    description: 'A fresh Kuwaiti-style thobe in serene powder blue. Made from a breathable cotton blend with a characteristic front pleat, tailored shoulders, and a relaxed fit perfect for warm-weather gatherings.',
    features: [
      { icon: '✦', title: 'Cotton blend', desc: 'Breathable cotton-poly blend that resists creasing.' },
      { icon: '✦', title: 'Front pleat', desc: 'Kuwaiti-style centre pleat for structured elegance.' },
      { icon: '✦', title: 'Powder blue', desc: 'A calming, fresh tone ideal for daytime occasions.' },
      { icon: '✦', title: 'Tailored shoulders', desc: 'Clean shoulder line for a polished, put-together look.' },
    ],
    images: {
  ...
  },
  {
    ...
    occasion: 'everyday',
    sizes: ['S', 'M', 'L', 'XL', 'XXL'],
    description: 'A breezy thobe in warm mocha beige, crafted from a premium linen blend for exceptional breathability. Lightweight and naturally textured, it’s the perfect companion for summer days and casual occasions.',
    features: [
      { icon: '✦', title: 'Linen blend', desc: 'Natural linen-cotton mix for superior breathability.' },
      { icon: '✦', title: 'Lightweight', desc: 'Featherlight construction for peak summer comfort.' },
      { icon: '✦', title: 'Natural texture', desc: 'Linen’s signature slub adds effortless character.' },
      { icon: '✦', title: 'Mocha beige', desc: 'A warm, earthy neutral that pairs with any sandal or shoe.' },
    ],
    images: {
  ...
  },
  {
    ...
    occasion: 'everyday',
    sizes: ['S', 'M', 'L', 'XL', 'XXL'],
    description: 'A crisp Saudi thobe in cool icy blue, crafted from premium breathable cotton. Features a clean-cut silhouette, structured collar, and subtle tone-on-tone stitching for a polished, contemporary look.',
    features: [
      { icon: '✦', title: 'Icy blue tone', desc: 'A cool, refreshing hue that stands out with quiet confidence.' },
      { icon: '✦', title: 'Tone-on-tone stitching', desc: 'Subtle matching thread work for refined detailing.' },
      { icon: '✦', title: 'Structured collar', desc: 'Crisp collar that holds its shape throughout the day.' },
      { icon: '✦', title: 'Breathable cotton', desc: 'Premium cotton for comfort in warm climates.' },
    ],
    images: {
      primary: 'https://res.cloudinary.com/dljg7vpso/image/upload/v1779384497/27_deunyz.png',
      secondary: 'https://res.cloudinary.com/dljg7vpso/image/upload/v1779388135/KhanSaab_3_gfj7qi.png',
    },
    gallery: [
      { label: 'ICY BLUE · FRONT', src: 'https://res.cloudinary.com/dljg7vpso/image/upload/v1779384497/27_deunyz.png' },
      { label: 'ICY BLUE · BACK', src: 'https://res.cloudinary.com/dljg7vpso/image/upload/v1779388135/KhanSaab_3_gfj7qi.png' },
      { label: 'ICY BLUE · DETAIL', src: 'https://res.cloudinary.com/dljg7vpso/image/upload/v1779384493/25_gbwnlg.png' },
      { label: 'ICY BLUE · SIDE', src: 'https://res.cloudinary.com/dljg7vpso/image/upload/v1779384488/24_ayzvx4.png' },
    ],
  },
  {
    ...
    tag: null,
    occasion: 'everyday',
    description: 'A classic shemag in soft cream beige, woven from 100% premium cotton. Lightweight yet warm, with traditional geometric patterns and hand-finished edges that honour centuries of craftsmanship.',
    features: [
      { icon: '✦', title: '100% cotton', desc: 'Pure premium cotton for softness and breathability.' },
      { icon: '✦', title: 'Traditional patterns', desc: 'Geometric motifs rooted in centuries of heritage.' },
      { icon: '✦', title: 'Hand-finished edges', desc: 'Carefully hemmed borders that resist fraying.' },
      { icon: '✦', title: 'Versatile drape', desc: 'Generous size for multiple styling options.' },
    ],
    images: {
      primary: 'https://res.cloudinary.com/dljg7vpso/image/upload/v1779386808/40_uucmgp.png',
      secondary: 'https://res.cloudinary.com/dljg7vpso/image/upload/v1779386808/40_uucmgp.png',
    },
  },
  {
    ...
    tag: null,
    occasion: 'everyday',
    description: 'A versatile shemag in refined light grey, crafted from premium woven cotton. Features traditional motifs with a modern palette, soft hand-feel, and generous dimensions for multiple styling options.',
    features: [
      { icon: '✦', title: 'Premium weave', desc: 'Tightly woven cotton for durability and drape.' },
      { icon: '✦', title: 'Modern palette', desc: 'Light grey that complements any thobe or outfit.' },
      { icon: '✦', title: 'Soft hand-feel', desc: 'Pre-washed fabric that feels worn-in from day one.' },
      { icon: '✦', title: 'Generous size', desc: 'Full dimensions for traditional or contemporary wrapping.' },
    ],
    images: {
      primary: 'https://res.cloudinary.com/dljg7vpso/image/upload/v1779386798/39_zvff9k.png',
      secondary: 'https://res.cloudinary.com/dljg7vpso/image/upload/v1779386798/39_zvff9k.png',
    },
  },
  {
    id: 'brown-shemag',
    ...
    tag: null,
    occasion: 'everyday',
    description: 'A rich brown shemag woven from premium cotton with traditional patterns. Earthy and distinguished, with reinforced edges and a soft drape perfect for everyday wear or special occasions.',
    features: [
      { icon: '✦', title: 'Earthy brown', desc: 'A warm, grounding tone inspired by desert landscapes.' },
      { icon: '✦', title: 'Reinforced edges', desc: 'Double-stitched borders built to last.' },
      { icon: '✦', title: 'Traditional weave', desc: 'Time-honoured pattern passed through generations.' },
      { icon: '✦', title: 'All-season weight', desc: 'Balanced weight suitable for year-round wear.' },
    ],
    images: {
      primary: 'https://res.cloudinary.com/dljg7vpso/image/upload/v1779386795/38_i4pjuv.png',
      secondary: 'https://res.cloudinary.com/dljg7vpso/image/upload/v1779386795/38_i4pjuv.png',
    },
  },
  {
    ...
    occasion: 'everyday',
    outOfStock: true,
    description: 'A striking keffiyah in deep royal red with intricate woven patterns. Made from premium yarn with traditional technique, featuring bold geometric motifs and hand-tied tassels along the border.',
    features: [
      { icon: '✦', title: 'Royal red', desc: 'A bold, striking hue that commands attention.' },
      { icon: '✦', title: 'Intricate weave', desc: 'Traditional loom-woven geometric patterns throughout.' },
      { icon: '✦', title: 'Hand-tied tassels', desc: 'Decorative border tassels finished by hand.' },
      { icon: '✦', title: 'Premium yarn', desc: 'High-quality thread for colour fastness and durability.' },
    ],
    images: {
      primary: 'https://res.cloudinary.com/dljg7vpso/image/upload/v1779386831/41_bhavvz.png',
