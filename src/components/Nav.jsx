    ...
    <>
      ...
      >
        ...
        <div
          style={{
            background: transparent
              ? "linear-gradient(180deg, rgba(10,9,8,0.55), transparent)"
        ...
        >
          ...
          >
            ...
            >
              <span data-logo-word>
                <KhanSaabLogo size={44} color={tone} invert={transparent} />
              </span>
              <span
                style={{ display: "none" }}
                data-logo-mark
      ...
      >
        ...
        <div style={{ marginTop: "auto", paddingTop: 32 }}>
          ...
          <button
            onClick={() => openWhatsApp(WHATSAPP_MESSAGES.customTailoring)}
            className="btn btn-gold"
            style={{ marginTop: 20, height: 44, fontSize: 11 }}
          >
            Chat on WhatsApp
          </button>
          <div
