    ...
    <div style={{ marginTop: 24 }}>
      ...
      >
        <div>
          ...
          {sub && (
            <span className="mono" style={{ marginLeft: 12, opacity: 0.55 }}>
              {sub}
            </span>
          )}
        </div>
        ...
        {images.map((_, i) => (
          <span
            ...
            style={{
              ...
              borderRadius: 3,
              background:
                i === active ? "var(--gold)" : "rgba(245,239,227,0.45)",
...
export default function ProductDetailPage() {
  ...
  const { openSizeGuide, opencollection } = useModals();
  ...
  const ctaHandler = () => {
    ...
    openWhatsApp(
      `${WHATSAPP_MESSAGES.fitting(PRODUCT.name, activeSize)}\n\nProduct link: ${productUrl}`,
    );
  };
  ...
  return (
    ...
    >
      <div
        className="container"
        style={{ padding: isPhone ? "12px 0 4px" : "20px 0" }}
      >
        <div
          className="mono"
          style={{
      ...
      >
        ...
        {isPhone ? (
          ...
          >
            ...
            <div style={{ position: "sticky", top: 110, alignSelf: "start" }}>
              ...
              >
                <Img
                  label={PRODUCT.gallery[activeImg].label}
                  src={PRODUCT.gallery[activeImg].src}
        ...
        <div>
          ...
          >
            ...
            <span
              className="mono"
              style={{ opacity: 0.6, fontSize: isPhone ? 10 : 11 }}
            >
          ...
          {PRODUCT.sizes.length > 0 && (
            <Selector
              label="Size"
              sub={isPhone ? `${activeSize}` : `${activeSize}`}
              action={
                <button
            ...
            >
              <div
                style={{
                  display: "grid",
                  gridTemplateColumns: isPhone ? "repeat(6, 1fr)" : "none",
                  gap: 8,
                  gridAutoFlow: isPhone ? "row" : undefined,
                }}
              >
                {!isPhone ? (
                      ...
                      <button
                        ...
                        style={{
                          ...
                          border:
                            s === activeSize
                              ? "1px solid var(--ink)"
                              : "1px solid rgba(10,9,8,0.15)",
                          background:
                            s === activeSize ? "var(--ink)" : "transparent",
                          color:
                            s === activeSize ? "var(--ivory)" : "var(--ink)",
                          fontSize: 13,
                          fontWeight: 500,
                          transition: "all 0.3s",
                        }}
          ...
          {!isPhone && (
            <>
              ...
              >
                Opens WhatsApp · {CONTACT.phoneDisplay} · {CONTACT.sla}
              </p>
            </>
          )}
            ...
            {SHIPPING_BADGES.map((s, i) => (
              ...
              >
                ...
                <div>
                  ...
                  <p
                    className="mono"
                    style={{ opacity: 0.55, fontSize: 10, marginTop: 2 }}
                  >
                    {s.d}
                  </p>
                </div>
            ...
            {[
              ...
              },
              {
                ...
                body: (
                  ...
                  >
                    The Sovereign sits true to size. A six-foot-one wearer with
                    a 102 cm chest fits EU 52. For a roomier silhouette, size up
                    one. For made-to-measure, book a 30-minute video
                    appointment.
                  </p>
                ),
              },
              {
                ...
                body: (
                  ...
                  >
                    Dry-clean only. Press inside out on a low setting. Avoid
                    direct sunlight when stored. We will press and refresh your
                    garment free of charge at any KhanSaab collection.
                  </p>
                ),
              },
              {
                ...
                body: (
                  ...
                  >
                    ...
                    days. Metro cities may receive earlier. Returns accepted
                    within 10 days of delivery in original condition.
                    Made-to-measure orders are final sale.
                  </p>
                ),
              },
            ].map((a) => (
              <div
                key={a.id}
                style={{ borderTop: "1px solid rgba(10,9,8,0.1)" }}
              >
                <button
                ...
                >
                  ...
                  <span
                    style={{
                      ...
                      transform:
                        acc === a.id ? "rotate(45deg)" : "rotate(0deg)",
                    }}
                  >
                    +
                  </span>
      ...
      <section
        style={{
          ...
          padding: isPhone ? "72px 0" : "120px 0",
          position: "relative",
        }}
      >
        <div className="container">
          <header
            style={{ textAlign: "center", marginBottom: isPhone ? 40 : 64 }}
          >
            <p
              className="eyebrow"
            ...
            {PDP_MAKING_STEPS.map((s, i) => (
              <div key={i}>
                <Img
                  label={`STEP ${i + 1}`}
                  src={s.src}
                  style={{ aspectRatio: "16/9", marginBottom: 14 }}
                />
                <p
                  className="mono"
                  style={{
                ...
                <h3
                  className="display"
                  style={{ fontSize: isPhone ? 20 : 26, marginBottom: 6 }}
                >
                  {s.t}
                </h3>
                <p style={{ fontSize: 13, opacity: 0.7, lineHeight: 1.55 }}>
                  {s.body}
                </p>
              </div>
            ))}
            ...
            >
              {REVIEW_HISTOGRAM.distribution.map(([n, c]) => (
                ...
                >
                  <span
                    className="mono"
                    style={{ minWidth: 32, fontSize: isPhone ? 10 : 11 }}
                  >
                    {n}★
                  </span>
                  <div
                  ...
                  >
                    <div
                      style={{
                        width: `${(c / REVIEW_HISTOGRAM.total) * 100}%`,
                        height: "100%",
                        background: "var(--emerald)",
                      }}
                    />
              ...
              {PRODUCT_REVIEWS.map((r, i) => (
                ...
                >
                  ...
                  >
                    ...
                    <p
                      className="mono"
                      style={{ opacity: 0.55, marginTop: 2, fontSize: 10 }}
                    >
                      {r.v}
                    </p>
                  </div>
            ...
            >
              {PRODUCT_REVIEWS.map((r, i) => (
                ...
                >
                  ...
                  >
                    <p style={{ fontSize: 13, fontWeight: 600 }}>{r.n}</p>
                    <p className="mono" style={{ opacity: 0.55, marginTop: 2 }}>
                      {r.v}
                    </p>
                  </div>
                </article>
      ...
      >
        <div className="container">
          <header
            style={{ textAlign: "center", marginBottom: isPhone ? 36 : 56 }}
          >
            <p
              className="eyebrow"
              style={{ color: "var(--emerald)", marginBottom: 14 }}
      ...
      {isPhone && (
        ...
        >
          <div style={{ flex: "0 0 auto", minWidth: 0 }}>
            <p
              className="mono"
              style={{ fontSize: 9.5, opacity: 0.55, letterSpacing: "0.18em" }}
            >
              {activeSize}
            </p>
            <p
